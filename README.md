...
- ⌨️ **Keyboard Shortcut**: Press `Ctrl+Shift+R` (Windows/Linux) or `MacCtrl+Shift+R` (Mac) to toggle RTL on/off instantly.
...
| Key | Action |
|-----|--------|
| `Ctrl+Shift+R` (Windows/Linux) | Toggle RTL on/off |
| `MacCtrl+Shift+R` (Mac) | Toggle RTL on/off |
